 ...
 * @author jakaniew
 */
public class ContentProject implements Project {

    private final FileObject projectDir;
    private final ProjectState state;
    private Lookup lkp;

    public ContentProject(FileObject dir, ProjectState state) {
        this.projectDir = dir;
        this.state = state;
    }
    ...
    public Lookup getLookup() {
        if (lkp == null) {
            lkp = Lookups.fixed(new Object[]{
                new Info(),
                new ContentProjectLogicalView(this),});
        }
        return lkp;
    }
